...
- Basado: GM y Manga se omiten de las sugerencias (incluidas variantes de espacios/mayúsculas). Se conservan los valores guardados y la entrada libre. Las sugerencias se limpian y deduplican con getBasedOnSuggestions; la consulta está en getCatalogBasedOnValues. El selector acepta un valor sin separar por comas. Ayuda actualizada en diez idiomas. Cualquier reclasificación de datos continúa pendiente de definición editorial de Flor.

...
const es: TranslationShape = {
  ...
  episodesList: {
    ...
    spoilerGateReasonEpisodeNotWatched: "Este contenido puede contener spoilers. Marca el episodio como visto para revelarlo.",
    commentsPlaceholder: "Escribe tus notas sobre este episodio, escenas interesantes, momentos clave...",
    embedSectionTitle: "📺 Reproducción oficial (opcional)",
    embedHelpText: "Pegá la URL de YouTube/Vimeo del canal oficial. Solo si la plataforma permite embeber legalmente. La plataforma se detecta automaticamente.",
  ...
  seriesInfoBlocksManager: {
    ...
    description: "Cards libres que aparecen en la página pública de la serie. Solo se muestran las que tienen contenido. Sirve para \"Basado en\", \"Curiosidades\", \"Premios\", o lo que se te ocurra.",
  ...
  newsAdmin: {
    ...
    aiDisclaimer: "La IA genera un resumen basado en el texto que pegues. El resultado siempre incluye el crédito a la fuente original. Revisá antes de publicar.",
  ...
  seasonEditForm: {
    ...
    castDescription: "Actores específicos de esta temporada (si difieren de la serie general)",
  ...
  clientVersionInfo: {
    ...
    copyTooltip: "Click para copiar version + dispositivo. Util para reportes de feedback.",
  ...
  verSerie: {
    ...
    inMyPersonalCatalogTooltip: "Esta serie también está en mi catálogo personal",
    ...
    officialPlaybackNote: "Reproducción oficial. Los derechos pertenecen a sus titulares.",
  ...
  noticiasList: {
    pageTitle: "Noticias BL/GL",
    pageSubtitle: "Las últimas novedades del mundo Boys Love y Girls Love, curadas para la comunidad.",
    searchPlaceholder: "Buscar noticias…",
    searchButton: "Buscar",
    searchResultsLabel: "Resultados para <strong>&quot;{activeSearch}&quot;</strong> · {total} {total, plural, one {noticia} other {noticias}}",
  ...
  adminInfo: {
    ...
    teamMemberJuanBio: "Full-stack developer. Responsable del desarrollo y mantenimiento de MundoBL.",
    teamMemberFlorName: "Flor",
    teamMemberFlorRole: "Product Owner",
    teamMemberFlorBio: "Responsable de las ideas, el contenido y la dirección del sitio. La verdadera experta en BLs.",
    linkConfigGithubLabel: "GitHub",
    linkConfigVercelLabel: "Vercel",
    linkConfigSupabaseLabel: "Supabase",
    platformsCardTitle: "Plataformas",
    noLinksConfiguredDescription: "No hay links configurados. Agregá las variables PROJECT_GITHUB_URL, PROJECT_VERCEL_URL, PROJECT_SUPABASE_URL en tu .env",
  ...
  profileSettings: {
    ...
    publicNameHint: "Es lo que ven otros usuarios en tus comentarios y reseñas. Si lo dejas vacio se muestra tu nombre con apellido abreviado (ej. {exampleName}).",
    nicknamePlaceholder: "Sin nickname (usar nombre + inicial)",
    saveButton: "Guardar",
    deleteConfirmOk: "OK",
    deleteAccountButton: "Eliminar cuenta",
    deleteIntro: "Estás a punto de eliminar tu cuenta. Por favor, selecciona cómo quieres manejar tus comentarios y reseñas existentes:",
    deletePolicyKeep: "Mantener mis comentarios y reseñas asociados a mi nombre de usuario.",
    deletePolicyAnonymize: "Anonimizar mis comentarios y reseñas (se mostrarán como de un usuario anónimo).",
    deletePolicyDelete: "Eliminar todos mis comentarios y reseñas.",
    deleteEmailLabel: "Para confirmar, escribe tu dirección de correo electrónico:",
  ...
  commentsList: {
    ...
    reportModalTitle: "Reportar comentario",
    reportModalHint: "Por favor, describe brevemente por qué estás reportando este comentario. Tu reporte nos ayuda a mantener un ambiente seguro y respetuoso.",
    reportPlaceholder: "¿Por qué reportas este comentario? (ej. spam, contenido ofensivo, información falsa)",
    reportButton: "Reportar",
    cancelButton: "Cancelar",
    tooltipPrivate: "Marcar como comentario privado (solo visible para ti y administradores)",
    ...
    placeholderPrivate: "Escribe un comentario privado (solo tú y los administradores lo verán)...",
  },
  statWidget: {
  ...
  liveRegion: {
    useLiveAnnouncerError: "useLiveAnnouncer debe usarse dentro de <LiveRegion>",
  },
  searchBar: {
    placeholder: "Buscar...",
  },
  ...
  spoilerFreeProvider: {
    useSpoilerFreeError: "useSpoilerFree debe usarse dentro de SpoilerFreeProvider",
  },
  themeProvider: {
...
const en: TranslationShape = {
  ...
  episodesList: {
    ...
    spoilerGateReasonEpisodeNotWatched: "This content may contain spoilers. Mark the episode as watched to reveal it.",
    commentsPlaceholder: "Write your notes about this episode, interesting scenes, key moments...",
    embedSectionTitle: "📺 Official playback (optional)",
    embedHelpText: "Paste the YouTube/Vimeo URL from the official channel. Only if the platform allows legal embedding. The platform is automatically detected.",
  ...
  seriesInfoBlocksManager: {
    ...
    description: "Free cards that appear on the public series page. Only those with content are shown. Useful for \"Based on\", \"Curiosities\", \"Awards\", or whatever you can think of.",
    addButton: "Add block",
  ...
  newsAdmin: {
    ...
    aiDisclaimer: "AI generates a summary based on the text you paste. The result always includes credit to the original source. Review before publishing.",
  ...
  seasonEditForm: {
    ...
    castDescription: "Specific actors for this season (if different from the general series)",
  ...
  clientVersionInfo: {
    ...
    copyTooltip: "Click to copy version + device info. Useful for feedback reports.",
  ...
  verSerie: {
    ...
    seriesMovedToPersonalCatalogSuccess: "Series moved to your personal catalog",
    couldNotMoveSeriesToCatalogError: "Could not move series to catalog",
    officialPlaybackNote: "Official playback. Rights belong to their respective owners.",
    creditsLink: "Credits",
  ...
  noticiasList: {
    pageTitle: "BL/GL News",
    pageSubtitle: "The latest news from the Boys Love and Girls Love world, curated for the community.",
    searchPlaceholder: "Search news…",
    searchButton: "Search",
    searchResultsLabel: "Results for <strong>&quot;{activeSearch}&quot;</strong> · {total} {total, plural, one {news item} other {news items}}",
  ...
  adminInfo: {
    ...
    teamMemberJuanBio: "Full-stack developer. Responsible for the development and maintenance of MundoBL.",
    teamMemberFlorName: "Flor",
    teamMemberFlorRole: "Product Owner",
    teamMemberFlorBio: "Responsible for the ideas, content, and direction of the site. The true expert in BLs.",
    linkConfigGithubLabel: "GitHub",
    linkConfigVercelLabel: "Vercel",
    linkConfigSupabaseLabel: "Supabase",
    platformsCardTitle: "Platforms",
    noLinksConfiguredDescription: "No links configured. Add PROJECT_GITHUB_URL, PROJECT_VERCEL_URL, PROJECT_SUPABASE_URL variables to your .env",
    teamCardTitle: "Team",
  },
  profileSettings: {
    ...
    publicNameHint: "This is what other users see in your comments and reviews. If you leave it empty, your name with an abbreviated surname will be displayed (e.g., {exampleName}).",
    nicknamePlaceholder: "No nickname (use name + initial)",
    saveButton: "Save",
    deleteConfirmOk: "OK",
    deleteAccountButton: "Delete account",
    deleteIntro: "You are about to delete your account. Please select how you want to handle your existing comments and reviews:",
    deletePolicyKeep: "Keep my comments and reviews associated with my username.",
    deletePolicyAnonymize: "Anonymize my comments and reviews (they will be shown as from an anonymous user).",
  ...
  commentsList: {
    ...
    reportModalTitle: "Report comment",
    reportModalHint: "Please briefly describe why you are reporting this comment. Your report helps us maintain a safe and respectful environment.",
    reportPlaceholder: "Why are you reporting this comment? (e.g., spam, offensive content, false information)",
    reportButton: "Report",
    cancelButton: "Cancel",
    tooltipPrivate: "Mark as private comment (only visible to you and administrators)",
    ...
    placeholderPrivate: "Write a private comment (only you and admins will see it)...",
  },
  statWidget: {
  ...
  spoilerFreeProvider: {
    useSpoilerFreeError: "useSpoilerFree must be used within a SpoilerFreeProvider",
  },
  themeProvider: {

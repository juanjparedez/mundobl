...
const ADMIN_LAYOUTS: DashboardLayouts = {
  lg: [
    ...
    // Row 1: Heatmap wide (8) + QuickAdmin (4). QuickAdmin son 6 tiles en
    // grilla de 3 columnas (2 filas de 64px+gap) — h:4 les da margen real,
    // h:3 quedaba al límite/clipeado segun density (--widget-body-padding).
    { i: WIDGET_IDS.heatmap, x: 0, y: 3, w: 8, h: 4 },
    { i: WIDGET_IDS.quickAdmin, x: 8, y: 3, w: 4, h: 4 },
    // Row 2: AdminAlerts full
    { i: WIDGET_IDS.adminAlerts, x: 0, y: 7, w: 12, h: 3 },
    // Row 3: CurrentlyWatching shelf full
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 10, w: 12, h: 4 },
    // Row 4: MyCases + Notifications (2up)
    { i: WIDGET_IDS.myCases, x: 0, y: 14, w: 6, h: 3 },
    { i: WIDGET_IDS.notifications, x: 6, y: 14, w: 6, h: 3 },
    // Row 5: MyReviews + MyDisputes + RecentlyCompleted (3up)
    { i: WIDGET_IDS.myReviews, x: 0, y: 17, w: 4, h: 4 },
    { i: WIDGET_IDS.myDisputes, x: 4, y: 17, w: 4, h: 4 },
    { i: WIDGET_IDS.recentlyCompleted, x: 8, y: 17, w: 4, h: 4 },
    // Row 6: GenresDonut + CompletedByYear (charts 4/8)
    { i: WIDGET_IDS.genres, x: 0, y: 21, w: 4, h: 5 },
    { i: WIDGET_IDS.completedByYear, x: 4, y: 21, w: 8, h: 5 },
    // Row 8: WorldMap wide (6) + TopCountries lista (3) + TopGenres (3).
    { i: WIDGET_IDS.worldMap, x: 0, y: 26, w: 6, h: 4 },
    { i: WIDGET_IDS.topCountries, x: 6, y: 26, w: 3, h: 4 },
    { i: WIDGET_IDS.topGenresList, x: 9, y: 26, w: 3, h: 4 },
    // Row 8b: TopActors + TopCompanies
    { i: WIDGET_IDS.topActors, x: 0, y: 30, w: 6, h: 4 },
    { i: WIDGET_IDS.topCompanies, x: 6, y: 30, w: 6, h: 4 },
    // Row 9: Collections + Achievements (2up)
    { i: WIDGET_IDS.collections, x: 0, y: 34, w: 6, h: 5 },
    { i: WIDGET_IDS.achievements, x: 6, y: 34, w: 6, h: 4 },
    // Row 10: Favorites + TopRated (2up)
    { i: WIDGET_IDS.favorites, x: 4, y: 39, w: 4, h: 4 },
    { i: WIDGET_IDS.topRated, x: 8, y: 38, w: 4, h: 4 },
    // Row 11: MyComments full
    { i: WIDGET_IDS.myComments, x: 0, y: 43, w: 12, h: 6, minW: 6, minH: 5 },
    // Row 12: Admin shared widgets
    { i: WIDGET_IDS.activityChart, x: 0, y: 49, w: 12, h: 5 },
    { i: WIDGET_IDS.recentAdminActivity, x: 0, y: 54, w: 6, h: 5 },
    { i: WIDGET_IDS.topCommenters, x: 6, y: 54, w: 6, h: 5 },
    { i: WIDGET_IDS.profileCompleteness, x: 0, y: 59, w: 4, h: 4 },
  ],
  md: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 10, h: 3 },
    { i: WIDGET_IDS.heatmap, x: 0, y: 3, w: 10, h: 3 },
    { i: WIDGET_IDS.quickAdmin, x: 0, y: 6, w: 5, h: 4 },
    { i: WIDGET_IDS.adminAlerts, x: 5, y: 6, w: 5, h: 3 },
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 10, w: 10, h: 4 },
    { i: WIDGET_IDS.myCases, x: 0, y: 14, w: 5, h: 3 },
    { i: WIDGET_IDS.notifications, x: 5, y: 14, w: 5, h: 3 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 17, w: 5, h: 4 },
    { i: WIDGET_IDS.myDisputes, x: 5, y: 17, w: 5, h: 4 },
    { i: WIDGET_IDS.genres, x: 0, y: 21, w: 5, h: 5 },
    { i: WIDGET_IDS.completedByYear, x: 5, y: 21, w: 5, h: 5 },
    { i: WIDGET_IDS.topGenresList, x: 0, y: 26, w: 5, h: 4 },
    { i: WIDGET_IDS.topCountries, x: 5, y: 26, w: 5, h: 4 },
    { i: WIDGET_IDS.topActors, x: 0, y: 30, w: 5, h: 4 },
    { i: WIDGET_IDS.topCompanies, x: 5, y: 30, w: 5, h: 4 },
    { i: WIDGET_IDS.collections, x: 0, y: 34, w: 5, h: 5 },
    { i: WIDGET_IDS.achievements, x: 5, y: 34, w: 5, h: 4 },
    { i: WIDGET_IDS.favorites, x: 5, y: 38, w: 5, h: 4 },
    { i: WIDGET_IDS.topRated, x: 0, y: 39, w: 5, h: 4 },
    { i: WIDGET_IDS.recentlyCompleted, x: 5, y: 42, w: 5, h: 4 },
    { i: WIDGET_IDS.myComments, x: 0, y: 46, w: 10, h: 6 },
  ],
  sm: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 6, h: 4 },
    { i: WIDGET_IDS.quickAdmin, x: 0, y: 4, w: 6, h: 4 },
    { i: WIDGET_IDS.adminAlerts, x: 0, y: 8, w: 6, h: 3 },
    { i: WIDGET_IDS.heatmap, x: 0, y: 11, w: 6, h: 3 },
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 14, w: 6, h: 4 },
    { i: WIDGET_IDS.notifications, x: 0, y: 18, w: 6, h: 3 },
    { i: WIDGET_IDS.myCases, x: 0, y: 21, w: 6, h: 3 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 24, w: 6, h: 4 },
    { i: WIDGET_IDS.genres, x: 0, y: 28, w: 6, h: 5 },
    { i: WIDGET_IDS.collections, x: 0, y: 33, w: 6, h: 5 },
    { i: WIDGET_IDS.achievements, x: 0, y: 38, w: 6, h: 5 },
    { i: WIDGET_IDS.favorites, x: 0, y: 43, w: 6, h: 4 },
    { i: WIDGET_IDS.topRated, x: 0, y: 47, w: 6, h: 4 },
    { i: WIDGET_IDS.myDisputes, x: 0, y: 51, w: 6, h: 3 },
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 54, w: 6, h: 4 },
    { i: WIDGET_IDS.topGenresList, x: 0, y: 58, w: 6, h: 3 },
    { i: WIDGET_IDS.topCountries, x: 0, y: 61, w: 6, h: 3 },
    { i: WIDGET_IDS.topActors, x: 0, y: 64, w: 6, h: 3 },
    { i: WIDGET_IDS.topCompanies, x: 0, y: 67, w: 6, h: 3 },
    { i: WIDGET_IDS.completedByYear, x: 0, y: 70, w: 6, h: 4 },
    { i: WIDGET_IDS.myComments, x: 0, y: 74, w: 6, h: 7 },
  ],
  xs: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 4, h: 5 },
    { i: WIDGET_IDS.quickAdmin, x: 0, y: 5, w: 4, h: 4 },
    { i: WIDGET_IDS.adminAlerts, x: 0, y: 9, w: 4, h: 3 },
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 12, w: 4, h: 4 },
    { i: WIDGET_IDS.heatmap, x: 0, y: 16, w: 4, h: 3 },
    { i: WIDGET_IDS.notifications, x: 0, y: 19, w: 4, h: 3 },
    { i: WIDGET_IDS.myCases, x: 0, y: 22, w: 4, h: 3 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 25, w: 4, h: 4 },
    { i: WIDGET_IDS.genres, x: 0, y: 29, w: 4, h: 5 },
    { i: WIDGET_IDS.collections, x: 0, y: 34, w: 4, h: 5 },
    { i: WIDGET_IDS.achievements, x: 0, y: 39, w: 4, h: 5 },
    { i: WIDGET_IDS.favorites, x: 0, y: 44, w: 4, h: 4 },
    { i: WIDGET_IDS.topRated, x: 0, y: 48, w: 4, h: 4 },
    { i: WIDGET_IDS.myDisputes, x: 0, y: 52, w: 4, h: 3 },
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 55, w: 4, h: 4 },
    { i: WIDGET_IDS.topGenresList, x: 0, y: 59, w: 4, h: 3 },
    { i: WIDGET_IDS.topCountries, x: 0, y: 62, w: 4, h: 3 },
    { i: WIDGET_IDS.topActors, x: 0, y: 65, w: 4, h: 3 },
    { i: WIDGET_IDS.topCompanies, x: 0, y: 68, w: 4, h: 3 },
    { i: WIDGET_IDS.completedByYear, x: 0, y: 71, w: 4, h: 4 },
    { i: WIDGET_IDS.myComments, x: 0, y: 75, w: 4, h: 7 },
  ],
};
...
const USER_LAYOUTS: DashboardLayouts = {
  lg: [
    ...
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 27, w: 3, h: 4 },
    { i: WIDGET_IDS.favorites, x: 3, y: 27, w: 3, h: 4 },
    { i: WIDGET_IDS.topRated, x: 6, y: 26, w: 3, h: 4 },
    { i: WIDGET_IDS.myDisputes, x: 9, y: 26, w: 3, h: 4 },
    { i: WIDGET_IDS.myComments, x: 0, y: 31, w: 8, h: 6, minW: 6, minH: 5 },
    { i: WIDGET_IDS.socials, x: 8, y: 30, w: 4, h: 6 },
    { i: WIDGET_IDS.profileCompleteness, x: 0, y: 37, w: 4, h: 4 },
  ],
  md: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 10, h: 3 },
    ...
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 31, w: 5, h: 4 },
    { i: WIDGET_IDS.favorites, x: 5, y: 30, w: 5, h: 4 },
    { i: WIDGET_IDS.topRated, x: 0, y: 35, w: 5, h: 4 },
    { i: WIDGET_IDS.myDisputes, x: 5, y: 34, w: 5, h: 4 },
    { i: WIDGET_IDS.myComments, x: 0, y: 39, w: 10, h: 6 },
  ],
  sm: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 6, h: 4 },
    ...
    { i: WIDGET_IDS.heatmap, x: 0, y: 18, w: 6, h: 3 },
    { i: WIDGET_IDS.genres, x: 0, y: 21, w: 6, h: 4 },
    { i: WIDGET_IDS.collections, x: 0, y: 25, w: 6, h: 5 },
    { i: WIDGET_IDS.achievements, x: 0, y: 30, w: 6, h: 5 },
    { i: WIDGET_IDS.topGenresList, x: 0, y: 35, w: 6, h: 3 },
    { i: WIDGET_IDS.topCountries, x: 0, y: 38, w: 6, h: 3 },
    { i: WIDGET_IDS.topActors, x: 0, y: 41, w: 6, h: 3 },
    { i: WIDGET_IDS.topCompanies, x: 0, y: 44, w: 6, h: 3 },
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 47, w: 6, h: 4 },
    { i: WIDGET_IDS.favorites, x: 0, y: 51, w: 6, h: 4 },
    { i: WIDGET_IDS.topRated, x: 0, y: 55, w: 6, h: 4 },
    { i: WIDGET_IDS.myDisputes, x: 0, y: 59, w: 6, h: 3 },
    { i: WIDGET_IDS.completedByYear, x: 0, y: 62, w: 6, h: 3 },
    { i: WIDGET_IDS.myComments, x: 0, y: 65, w: 6, h: 7 },
  ],
  xs: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 4, h: 5 },
    ...
    { i: WIDGET_IDS.heatmap, x: 0, y: 19, w: 4, h: 3 },
    { i: WIDGET_IDS.genres, x: 0, y: 22, w: 4, h: 4 },
    { i: WIDGET_IDS.collections, x: 0, y: 26, w: 4, h: 5 },
    ...
    { i: WIDGET_IDS.completedByYear, x: 0, y: 63, w: 4, h: 3 },
    { i: WIDGET_IDS.myComments, x: 0, y: 66, w: 4, h: 7 },
  ],
};
...
const BASIC_LAYOUTS: DashboardLayouts = {
  lg: [
    ...
    { i: WIDGET_IDS.profileCompleteness, x: 0, y: 18, w: 4, h: 4 },
  ],
  md: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 10, h: 3 },
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 3, w: 10, h: 4 },
  ...
  sm: [
    ...
    { i: WIDGET_IDS.socials, x: 0, y: 24, w: 6, h: 4 },
  ],
  xs: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 4, h: 5 },
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 5, w: 4, h: 4 },
    ...
    { i: WIDGET_IDS.socials, x: 0, y: 25, w: 4, h: 4 },
  ],
};

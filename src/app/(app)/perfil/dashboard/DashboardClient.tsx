...
const ADMIN_LAYOUTS: DashboardLayouts = {
  lg: [
    ...
    { i: WIDGET_IDS.favorites, x: 4, y: 38, w: 4, h: 4 },
    { i: WIDGET_IDS.topRated, x: 8, y: 37, w: 4, h: 4 },
    // Row 11: MyComments full
    { i: WIDGET_IDS.myComments, x: 0, y: 42, w: 12, h: 6, minW: 6, minH: 5 },
    // Row 12: Admin shared widgets
    { i: WIDGET_IDS.activityChart, x: 0, y: 48, w: 12, h: 5 },
    { i: WIDGET_IDS.recentAdminActivity, x: 0, y: 53, w: 6, h: 5 },
    { i: WIDGET_IDS.topCommenters, x: 6, y: 53, w: 6, h: 5 },
    { i: WIDGET_IDS.profileCompleteness, x: 0, y: 58, w: 4, h: 4 },
  ],
  md: [
    ...
    { i: WIDGET_IDS.myCases, x: 0, y: 13, w: 5, h: 3 },
    { i: WIDGET_IDS.notifications, x: 5, y: 13, w: 5, h: 3 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 16, w: 5, h: 4 },
    { i: WIDGET_IDS.myDisputes, x: 5, y: 16, w: 5, h: 4 },
    ...
    { i: WIDGET_IDS.topRated, x: 0, y: 38, w: 5, h: 4 },
  ...
  sm: [
    ...
    { i: WIDGET_IDS.notifications, x: 0, y: 17, w: 6, h: 3 },
    { i: WIDGET_IDS.myCases, x: 0, y: 20, w: 6, h: 3 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 23, w: 6, h: 4 },
    { i: WIDGET_IDS.genres, x: 0, y: 27, w: 6, h: 5 },
    { i: WIDGET_IDS.collections, x: 0, y: 32, w: 6, h: 5 },
    { i: WIDGET_IDS.achievements, x: 0, y: 37, w: 6, h: 5 },
    { i: WIDGET_IDS.favorites, x: 0, y: 42, w: 6, h: 4 },
    { i: WIDGET_IDS.topRated, x: 0, y: 46, w: 6, h: 4 },
    { i: WIDGET_IDS.myDisputes, x: 0, y: 50, w: 6, h: 3 },
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 53, w: 6, h: 4 },
    { i: WIDGET_IDS.topGenresList, x: 0, y: 57, w: 6, h: 3 },
    { i: WIDGET_IDS.topCountries, x: 0, y: 60, w: 6, h: 3 },
    { i: WIDGET_IDS.topActors, x: 0, y: 63, w: 6, h: 3 },
    { i: WIDGET_IDS.topCompanies, x: 0, y: 66, w: 6, h: 3 },
    { i: WIDGET_IDS.completedByYear, x: 0, y: 69, w: 6, h: 4 },
  ...
  xs: [
    ...
    { i: WIDGET_IDS.notifications, x: 0, y: 18, w: 4, h: 3 },
    { i: WIDGET_IDS.myCases, x: 0, y: 21, w: 4, h: 3 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 24, w: 4, h: 4 },
    { i: WIDGET_IDS.genres, x: 0, y: 28, w: 4, h: 5 },
    { i: WIDGET_IDS.collections, x: 0, y: 33, w: 4, h: 5 },
    { i: WIDGET_IDS.achievements, x: 0, y: 38, w: 4, h: 5 },
    { i: WIDGET_IDS.favorites, x: 0, y: 43, w: 4, h: 4 },
    { i: WIDGET_IDS.topRated, x: 0, y: 47, w: 4, h: 4 },
    { i: WIDGET_IDS.myDisputes, x: 0, y: 51, w: 4, h: 3 },
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 54, w: 4, h: 4 },
    { i: WIDGET_IDS.topGenresList, x: 0, y: 58, w: 4, h: 3 },
    { i: WIDGET_IDS.topCountries, x: 0, y: 61, w: 4, h: 3 },
    { i: WIDGET_IDS.topActors, x: 0, y: 64, w: 4, h: 3 },
    { i: WIDGET_IDS.topCompanies, x: 0, y: 67, w: 4, h: 3 },
    { i: WIDGET_IDS.completedByYear, x: 0, y: 70, w: 4, h: 4 },
    { i: WIDGET_IDS.myComments, x: 0, y: 74, w: 4, h: 7 },
  ],
};

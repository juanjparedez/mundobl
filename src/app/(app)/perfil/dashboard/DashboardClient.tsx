...
const ADMIN_LAYOUTS: DashboardLayouts = {
  lg: [
    ...
    // Row 1: Heatmap wide (8) + QuickAdmin (4). Alturas recalculadas con la
    // formula REAL del grid (rowHeight=36 gap=10 -> boxHeight(h)=46h-10),
    // no los defaults de DashboardGrid (60/16) que se venian asumiendo por
    // error — ese desfase es la causa raiz de todo el "widgets cortados".
    { i: WIDGET_IDS.heatmap, x: 0, y: 3, w: 8, h: 5 },
    { i: WIDGET_IDS.quickAdmin, x: 8, y: 3, w: 4, h: 5 },
    // Row 2: AdminAlerts full
    { i: WIDGET_IDS.adminAlerts, x: 0, y: 8, w: 12, h: 6 },
    // Row 3: CurrentlyWatching shelf full
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 14, w: 12, h: 5 },
    // Row 4: MyCases + Notifications (2up)
    { i: WIDGET_IDS.myCases, x: 0, y: 19, w: 6, h: 4 },
    { i: WIDGET_IDS.notifications, x: 6, y: 19, w: 6, h: 4 },
    // Row 5: MyReviews + MyDisputes + RecentlyCompleted (3up)
    { i: WIDGET_IDS.myReviews, x: 0, y: 23, w: 4, h: 6 },
    { i: WIDGET_IDS.myDisputes, x: 4, y: 23, w: 4, h: 6 },
    { i: WIDGET_IDS.recentlyCompleted, x: 8, y: 23, w: 4, h: 5 },
    // Row 6: GenresDonut + CompletedByYear (charts 4/8)
    { i: WIDGET_IDS.genres, x: 0, y: 29, w: 4, h: 6 },
    { i: WIDGET_IDS.completedByYear, x: 4, y: 29, w: 8, h: 6 },
    // Row 8: WorldMap wide (6) + TopCountries lista (3) + TopGenres (3).
    { i: WIDGET_IDS.worldMap, x: 0, y: 35, w: 6, h: 6 },
    { i: WIDGET_IDS.topCountries, x: 6, y: 35, w: 3, h: 6 },
    { i: WIDGET_IDS.topGenresList, x: 9, y: 35, w: 3, h: 6 },
    // Row 8b: TopActors + TopCompanies
    { i: WIDGET_IDS.topActors, x: 0, y: 41, w: 6, h: 6 },
    { i: WIDGET_IDS.topCompanies, x: 6, y: 41, w: 6, h: 6 },
    // Row 9: Collections + Achievements (2up)
    { i: WIDGET_IDS.collections, x: 0, y: 47, w: 6, h: 5 },
    { i: WIDGET_IDS.achievements, x: 6, y: 47, w: 6, h: 5 },
    // Row 10: Favorites + TopRated (2up)
    { i: WIDGET_IDS.favorites, x: 4, y: 52, w: 4, h: 7 },
    { i: WIDGET_IDS.topRated, x: 8, y: 52, w: 4, h: 5 },
    // Row 11: MyComments full
    { i: WIDGET_IDS.myComments, x: 0, y: 59, w: 12, h: 6, minW: 6, minH: 5 },
    // Row 12: Admin shared widgets
    { i: WIDGET_IDS.activityChart, x: 0, y: 65, w: 12, h: 6 },
    { i: WIDGET_IDS.recentAdminActivity, x: 0, y: 71, w: 6, h: 6 },
    { i: WIDGET_IDS.topCommenters, x: 6, y: 71, w: 6, h: 5 },
    { i: WIDGET_IDS.profileCompleteness, x: 0, y: 77, w: 4, h: 4 },
  ],
  md: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 10, h: 3 },
    { i: WIDGET_IDS.heatmap, x: 0, y: 3, w: 10, h: 5 },
    { i: WIDGET_IDS.quickAdmin, x: 0, y: 8, w: 5, h: 5 },
    { i: WIDGET_IDS.adminAlerts, x: 5, y: 8, w: 5, h: 6 },
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 14, w: 10, h: 5 },
    { i: WIDGET_IDS.myCases, x: 0, y: 19, w: 5, h: 4 },
    { i: WIDGET_IDS.notifications, x: 5, y: 19, w: 5, h: 4 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 23, w: 5, h: 6 },
    { i: WIDGET_IDS.myDisputes, x: 5, y: 23, w: 5, h: 6 },
    { i: WIDGET_IDS.genres, x: 0, y: 29, w: 5, h: 6 },
    { i: WIDGET_IDS.completedByYear, x: 5, y: 29, w: 5, h: 6 },
    { i: WIDGET_IDS.topGenresList, x: 0, y: 35, w: 5, h: 6 },
    { i: WIDGET_IDS.topCountries, x: 5, y: 35, w: 5, h: 6 },
    { i: WIDGET_IDS.topActors, x: 0, y: 41, w: 5, h: 6 },
    { i: WIDGET_IDS.topCompanies, x: 5, y: 41, w: 5, h: 6 },
    { i: WIDGET_IDS.collections, x: 0, y: 47, w: 5, h: 5 },
    { i: WIDGET_IDS.achievements, x: 5, y: 47, w: 5, h: 5 },
    { i: WIDGET_IDS.favorites, x: 5, y: 52, w: 5, h: 7 },
  ...
  sm: [
    ...
    { i: WIDGET_IDS.quickAdmin, x: 0, y: 4, w: 6, h: 5 },
    { i: WIDGET_IDS.adminAlerts, x: 0, y: 9, w: 6, h: 6 },
    { i: WIDGET_IDS.heatmap, x: 0, y: 15, w: 6, h: 5 },
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 20, w: 6, h: 5 },
    { i: WIDGET_IDS.notifications, x: 0, y: 25, w: 6, h: 4 },
    { i: WIDGET_IDS.myCases, x: 0, y: 29, w: 6, h: 4 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 33, w: 6, h: 6 },
    { i: WIDGET_IDS.genres, x: 0, y: 39, w: 6, h: 6 },
    { i: WIDGET_IDS.collections, x: 0, y: 45, w: 6, h: 5 },
    { i: WIDGET_IDS.achievements, x: 0, y: 50, w: 6, h: 5 },
    { i: WIDGET_IDS.favorites, x: 0, y: 55, w: 6, h: 7 },
    { i: WIDGET_IDS.topRated, x: 0, y: 62, w: 6, h: 5 },
    { i: WIDGET_IDS.myDisputes, x: 0, y: 67, w: 6, h: 6 },
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 73, w: 6, h: 5 },
    { i: WIDGET_IDS.topGenresList, x: 0, y: 78, w: 6, h: 6 },
    { i: WIDGET_IDS.topCountries, x: 0, y: 84, w: 6, h: 6 },
    { i: WIDGET_IDS.topActors, x: 0, y: 90, w: 6, h: 6 },
  ...
  xs: [
    ...
    { i: WIDGET_IDS.quickAdmin, x: 0, y: 5, w: 4, h: 5 },
    { i: WIDGET_IDS.adminAlerts, x: 0, y: 10, w: 4, h: 6 },
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 16, w: 4, h: 5 },
    { i: WIDGET_IDS.heatmap, x: 0, y: 21, w: 4, h: 5 },
    { i: WIDGET_IDS.notifications, x: 0, y: 26, w: 4, h: 4 },
    { i: WIDGET_IDS.myCases, x: 0, y: 30, w: 4, h: 4 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 34, w: 4, h: 6 },
    { i: WIDGET_IDS.genres, x: 0, y: 40, w: 4, h: 6 },
    { i: WIDGET_IDS.collections, x: 0, y: 46, w: 4, h: 5 },
    { i: WIDGET_IDS.achievements, x: 0, y: 51, w: 4, h: 5 },
    { i: WIDGET_IDS.favorites, x: 0, y: 56, w: 4, h: 7 },
    { i: WIDGET_IDS.topRated, x: 0, y: 63, w: 4, h: 5 },
    { i: WIDGET_IDS.myDisputes, x: 0, y: 68, w: 4, h: 6 },
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 74, w: 4, h: 5 },
    { i: WIDGET_IDS.topGenresList, x: 0, y: 79, w: 4, h: 6 },
    { i: WIDGET_IDS.topCountries, x: 0, y: 85, w: 4, h: 6 },
    { i: WIDGET_IDS.topActors, x: 0, y: 91, w: 4, h: 6 },
...
const USER_LAYOUTS: DashboardLayouts = {
  lg: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 12, h: 3 },
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 3, w: 12, h: 5 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 8, w: 5, h: 6 },
    { i: WIDGET_IDS.notifications, x: 5, y: 8, w: 4, h: 4 },
    { i: WIDGET_IDS.myCases, x: 9, y: 8, w: 3, h: 4 },
    { i: WIDGET_IDS.heatmap, x: 0, y: 14, w: 6, h: 5 },
    { i: WIDGET_IDS.genres, x: 6, y: 12, w: 3, h: 6 },
    { i: WIDGET_IDS.completedByYear, x: 9, y: 12, w: 3, h: 6 },
    // Row "paises": WorldMap wide (6) + TopCountries lista (3) +
    // TopGenresList (3). Complementarios: mapa visual + listas detalladas.
    { i: WIDGET_IDS.worldMap, x: 0, y: 19, w: 6, h: 6 },
    { i: WIDGET_IDS.topCountries, x: 6, y: 18, w: 3, h: 6 },
    { i: WIDGET_IDS.topGenresList, x: 9, y: 18, w: 3, h: 6 },
    { i: WIDGET_IDS.topActors, x: 0, y: 25, w: 6, h: 6 },
    { i: WIDGET_IDS.topCompanies, x: 6, y: 24, w: 6, h: 6 },
    { i: WIDGET_IDS.collections, x: 0, y: 31, w: 6, h: 5 },
    { i: WIDGET_IDS.achievements, x: 6, y: 30, w: 6, h: 5 },
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 36, w: 3, h: 5 },
    { i: WIDGET_IDS.favorites, x: 3, y: 36, w: 3, h: 7 },
    { i: WIDGET_IDS.topRated, x: 6, y: 35, w: 3, h: 5 },
    { i: WIDGET_IDS.myDisputes, x: 9, y: 35, w: 3, h: 6 },
  ...
  md: [
    ...
    { i: WIDGET_IDS.myReviews, x: 0, y: 8, w: 5, h: 6 },
    { i: WIDGET_IDS.notifications, x: 5, y: 8, w: 5, h: 4 },
    { i: WIDGET_IDS.myCases, x: 0, y: 14, w: 5, h: 4 },
    { i: WIDGET_IDS.heatmap, x: 5, y: 12, w: 5, h: 5 },
    { i: WIDGET_IDS.genres, x: 0, y: 18, w: 5, h: 6 },
    { i: WIDGET_IDS.completedByYear, x: 5, y: 17, w: 5, h: 6 },
    { i: WIDGET_IDS.topGenresList, x: 0, y: 24, w: 5, h: 6 },
    { i: WIDGET_IDS.topCountries, x: 5, y: 23, w: 5, h: 6 },
    { i: WIDGET_IDS.topActors, x: 0, y: 30, w: 5, h: 6 },
    { i: WIDGET_IDS.topCompanies, x: 5, y: 29, w: 5, h: 6 },
    { i: WIDGET_IDS.collections, x: 0, y: 36, w: 5, h: 5 },
    { i: WIDGET_IDS.achievements, x: 5, y: 35, w: 5, h: 5 },
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 41, w: 5, h: 5 },
    { i: WIDGET_IDS.favorites, x: 5, y: 40, w: 5, h: 7 },
  ...
  sm: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 6, h: 4 },
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 4, w: 6, h: 5 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 9, w: 6, h: 6 },
    { i: WIDGET_IDS.notifications, x: 0, y: 15, w: 6, h: 4 },
    { i: WIDGET_IDS.myCases, x: 0, y: 19, w: 6, h: 4 },
    { i: WIDGET_IDS.heatmap, x: 0, y: 23, w: 6, h: 5 },
    { i: WIDGET_IDS.genres, x: 0, y: 28, w: 6, h: 6 },
    { i: WIDGET_IDS.collections, x: 0, y: 34, w: 6, h: 5 },
    { i: WIDGET_IDS.achievements, x: 0, y: 39, w: 6, h: 5 },
    { i: WIDGET_IDS.topGenresList, x: 0, y: 44, w: 6, h: 6 },
    { i: WIDGET_IDS.topCountries, x: 0, y: 50, w: 6, h: 6 },
    { i: WIDGET_IDS.topActors, x: 0, y: 56, w: 6, h: 6 },
    { i: WIDGET_IDS.topCompanies, x: 0, y: 62, w: 6, h: 6 },
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 68, w: 6, h: 5 },
    { i: WIDGET_IDS.favorites, x: 0, y: 73, w: 6, h: 7 },
    { i: WIDGET_IDS.topRated, x: 0, y: 80, w: 6, h: 5 },
  ...
  xs: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 4, h: 5 },
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 5, w: 4, h: 5 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 10, w: 4, h: 6 },
    { i: WIDGET_IDS.notifications, x: 0, y: 16, w: 4, h: 4 },
    { i: WIDGET_IDS.myCases, x: 0, y: 20, w: 4, h: 4 },
    { i: WIDGET_IDS.heatmap, x: 0, y: 24, w: 4, h: 5 },
    { i: WIDGET_IDS.genres, x: 0, y: 29, w: 4, h: 6 },
    { i: WIDGET_IDS.collections, x: 0, y: 35, w: 4, h: 5 },
    { i: WIDGET_IDS.achievements, x: 0, y: 40, w: 4, h: 5 },
    { i: WIDGET_IDS.topGenresList, x: 0, y: 45, w: 4, h: 6 },
    { i: WIDGET_IDS.topCountries, x: 0, y: 51, w: 4, h: 6 },
    { i: WIDGET_IDS.topActors, x: 0, y: 57, w: 4, h: 6 },
    { i: WIDGET_IDS.topCompanies, x: 0, y: 63, w: 4, h: 6 },
    { i: WIDGET_IDS.recentlyCompleted, x: 0, y: 69, w: 4, h: 5 },
    { i: WIDGET_IDS.favorites, x: 0, y: 74, w: 4, h: 7 },
    { i: WIDGET_IDS.topRated, x: 0, y: 81, w: 4, h: 5 },
...
const BASIC_LAYOUTS: DashboardLayouts = {
  lg: [
    { i: WIDGET_IDS.statsStrip, x: 0, y: 0, w: 12, h: 3 },
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 3, w: 12, h: 5 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 8, w: 6, h: 6 },
    { i: WIDGET_IDS.myComments, x: 6, y: 8, w: 6, h: 6 },
    { i: WIDGET_IDS.heatmap, x: 0, y: 14, w: 8, h: 5 },
  ...
  md: [
    ...
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 3, w: 10, h: 5 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 8, w: 5, h: 6 },
    { i: WIDGET_IDS.myComments, x: 5, y: 8, w: 5, h: 6 },
  ...
  sm: [
    ...
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 4, w: 6, h: 5 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 9, w: 6, h: 6 },
    { i: WIDGET_IDS.myComments, x: 0, y: 15, w: 6, h: 6 },
  ...
  xs: [
    ...
    { i: WIDGET_IDS.currentlyWatching, x: 0, y: 5, w: 4, h: 5 },
    { i: WIDGET_IDS.myReviews, x: 0, y: 10, w: 4, h: 6 },
    { i: WIDGET_IDS.myComments, x: 0, y: 16, w: 4, h: 6 },
...
export function DashboardClient() {
  ...
  useMemo(() => {
    WidgetRegistry.register({
      ...
      defaultSize: { w: 8, h: 5, minW: 6, minH: 3 },
    ...
    WidgetRegistry.register({
      ...
      defaultSize: { w: 4, h: 5, minW: 4, minH: 3 },
    ...
    WidgetRegistry.register({
      ...
      defaultSize: { w: 12, h: 6, minW: 6, minH: 3 },
    ...
    WidgetRegistry.register({
      ...
      defaultSize: { w: 7, h: 6, minW: 4, minH: 4 },

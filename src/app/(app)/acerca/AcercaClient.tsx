    ...
    <div className="acerca-container">
      ...
      <header className="acerca-hero">
        <div className="acerca-hero__badge">
          <HeartFilled style={{ color: '#ff4d4f' }} /> Proyecto Independiente &
          Comunitario
        </div>
        ...
        <p className="acerca-hero__subtitle">
          MundoBL nació de una pasión compartida: crear un espacio limpio,
          rápido, sin publicidad invasiva y 100% legal para descubrir, seguir y
          debatir las mejores producciones asiáticas y universales.
        </p>
      </header>
        ...
        <div className="acerca-team-grid">
          <div className="acerca-member-card">
            ...
            <div className="acerca-member-card__info">
              ...
              <p className="acerca-member-card__bio">
                Desarrollador Full-Stack. Responsable de la arquitectura
                técnica, diseño de interfaz, optimización de rendimiento y del
                reproductor integrado de MundoBL.
              </p>
          ...
          <div className="acerca-member-card">
            ...
            <div className="acerca-member-card__info">
              ...
              <p className="acerca-member-card__bio">
                La verdadera experta en BLs y series asiáticas. Responsable de
                la dirección del producto, selección del catálogo, organización
                de novedades y el pulso de la comunidad.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="acerca-section">
        ...
        <div className="acerca-values-grid">
          ...
          <div className="acerca-value-box">
            ...
            <p>
              Creemos que el acceso a la cultura y a las series oficiales debe
              ser libre. No cobramos mensualidades para ver contenido ni te
              obligamos a pagar para desbloquear episodios.
            </p>
          </div>
          ...
          <div className="acerca-value-box">
            ...
            <p>
              Te decimos la verdad sobre dónde ver cada serie: cuándo está
              gratis, cuándo conviene una suscripción VIP (como GagaOOLala o
              Rakuten Viki) y cuáles tienen versión Uncut sin censura.
            </p>
          </div>
          ...
          <div className="acerca-value-box">
            ...
            <p>
              No usamos algoritmos ocultos ni inflamos calificaciones. Los
              números de calificaciones, favoritos y visualizaciones son 100%
              transparentes y calculados directamente de los aportes de los
              usuarios.
            </p>
          </div>
        </div>
      ...
      <section className="acerca-contact-box">
        ...
        <p>
          MundoBL crece con la comunidad. Si encontrás algún dato para corregir
          o querés proponer una funcionalidad, estamos siempre escuchando.
        </p>
        <div className="acerca-contact-box__actions">
          ...
          <Link href="/estadisticas">
            <Button size="large">Ver Estadísticas de la Comunidad</Button>
          </Link>
        </div>
      </section>
    </div>

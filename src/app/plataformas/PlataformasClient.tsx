...
export function PlataformasClient() {
  const [filter, setFilter] = useState<'all' | 'uncut' | 'free' | 'no-vpn'>('all');
    ...
    <div className="plataformas-container">
      ...
      <header className="plataformas-hero">
        ...
        <p className="plataformas-hero__subtitle">
          El ecosistema BL/GL está dividido entre varios servicios. Acá tenés una guía transparente con precios reales, versiones sin censura (Uncut), subtítulos en español y qué conviene contratar según tus gustos.
        </p>
        ...
        <div className="plataformas-filters">
          <Radio.Group
            ...
            size="middle"
          >
            <Radio.Button value="all">Todas ({STREAMING_PLATFORMS.length})</Radio.Button>
            <Radio.Button value="free">Con opción Gratis</Radio.Button>
            <Radio.Button value="uncut">Versiones Uncut (Sin censura)</Radio.Button>
            <Radio.Button value="no-vpn">Sin VPN (Disponibles en LATAM/ES)</Radio.Button>
          </Radio.Group>
        </div>
      </header>
          ...
          <div key={platform.id} className="plataforma-card">
            ...
            >
              <div className="plataforma-card__title-row">
                <h2 className="plataforma-card__name" style={{ color: platform.color }}>
                  {platform.name}
                </h2>
                <a
            ...
            <div className="plataforma-card__plans-section">
              <h3 className="plataforma-card__plans-title">Planes y Precios:</h3>
                ...
                {platform.plans.map((plan, idx) => (
                  <div key={idx} className="plataforma-plan-box">
                    <div className="plataforma-plan-box__head">
                      <span className="plataforma-plan-box__name">{plan.name}</span>
                    ...
                    <ul className="plataforma-plan-box__features">
                      {plan.features.map((feat, fIdx) => (
                        <li key={fIdx}>
                          <CheckOutlined className="plataforma-plan-box__check" /> {feat}
                        </li>
                      ))}
                    </ul>
                  </div>
      ...
      <section className="plataformas-faq">
        <h2 className="plataformas-faq__title">
          <InfoCircleOutlined /> Guía de Arbitraje: ¿Dónde ver cada tipo de serie?
        </h2>
        <div className="plataformas-faq__cards">
          <div className="plataformas-faq__card">
            ...
            <p>
              La gran mayoría se emiten <strong>gratis y completas en YouTube oficial</strong> semana a semana con subtítulos en español. Si querés ver la versión extendida sin censura (Uncut), habitualmente se publica en <strong>iQIYI VIP</strong> o <strong>GagaOOLala VIP</strong>.
            </p>
          </div>
          ...
          <div className="plataformas-faq__card">
            ...
            <p>
              Los K-BLs suelen estrenarse en <strong>Rakuten Viki</strong> o <strong>GagaOOLala</strong>. Para películas independientes de autor (como las de <em>Strongberry</em>), el mejor lugar es <strong>Vimeo On Demand</strong>, donde compras el título individual y apoyas directo a la productora.
            </p>
          </div>
          ...
          <div className="plataformas-faq__card">
            ...
            <p>
              Taiwán y Japón apuestan fuertemente por <strong>GagaOOLala</strong> y <strong>Rakuten Viki</strong> para su distribución mundial con traducción oficial y sin cortes.
            </p>
          </div>
        </div>
      </section>

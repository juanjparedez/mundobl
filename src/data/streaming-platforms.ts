  ...
  },
  {
    ...
    plans: [
      ...
      },
      {
        ...
        price: '$13.99 USD',
        period: '3 meses',
        features: ['10% de descuento', 'Acceso completo VIP', 'Full HD 1080p sin anuncios'],
      },
      {
        name: 'VIP Semestral (20% OFF)',
        price: '$23.99 USD',
        period: '6 meses',
        features: ['20% de descuento', 'Acceso completo VIP', 'Full HD 1080p sin anuncios'],
      },
      {
        name: 'VIP Anual (30% OFF)',
        price: '$43.99 USD',
        period: '12 meses',
        features: ['30% de descuento ($3.66/mes)', 'Acceso prioritario a finales y uncut', 'Todas las ventajas VIP'],
      },
    ],
    uncutAvailable: true,
    spanishSubs: true,

              ...
              <div className="help-modal__section">
                <div className="help-modal__shortcut-row">
                  <span className="help-modal__shortcut-desc">
                    <SearchOutlined /> Abrir buscador global de series y
                    personas
                  </span>
                ...
                <div className="help-modal__shortcut-row">
                  <span className="help-modal__shortcut-desc">
                    <PlayCircleOutlined /> Navegar al siguiente / anterior
                    capítulo en /ver
                  </span>
                  <span className="help-modal__keys">
                    <kbd>←</kbd> <kbd>→</kbd>
          ...
          },
          {
            ...
            children: (
              <div className="help-modal__section help-modal__text-content">
                ...
                <p>
                  MundoBL reproduce las transmisiones oficiales alojadas en
                  canales autorizados (YouTube, Vimeo, Bilibili).
                </p>
                <ul>
                  <li>
                    <strong>Subtítulos en español:</strong> Se solicitan
                    automáticamente. Si el canal oficial dispone de CC en
                    español, aparecerán activados. Podés ajustar idioma y tamaño
                    desde el botón <strong>[CC]</strong> del reproductor.
                  </li>
                  <li>
                    <strong>Partes y Capítulos:</strong> Muchas productoras
                    tailandesas dividen los episodios en 4 partes (ej:{' '}
                    <code>[1/4]</code> a <code>[4/4]</code>). Podés saltar entre
                    partes directamente desde el selector inferior.
                  </li>
                </ul>
              </div>
            ),
          },
          {
            ...
            children: (
              <div className="help-modal__section help-modal__text-content">
                ...
                <p>
                  Te ayudamos a saber dónde ver legalmente cada serie, qué
                  plataformas ofrecen versión Uncut sin censura y qué planes
                  existen (Gratis con publicidad, VIP mensual o compra digital).
                </p>
                <p>
